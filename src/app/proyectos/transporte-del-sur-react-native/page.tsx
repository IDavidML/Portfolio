...
function TransporteDelSur() {
  return (
    <div className='flex flex-col'>
      <h1 className='text-5xl font-semibold mb-8 text-center'>Transporte del Sur (React Native)</h1>
      <p className='py-2'>Aplicación reprogramada desde 0 con React Native, en la cual podrás consultar con mayor facilidad las líneas interurbanas disponibles en tu provincia (Solo en la comunidad autónoma de Andalucía).</p>
      ...
      <div className='grid grid-cols-4 my-8 gap-4'>
        {
          Array.from(Array(7), (e, i) => {
            if(i == 0) return null
            return <Image key={i} alt={`Imagen ${i}`} src={`/projects/transporte-del-sur-react-native/image${i}.png`} width={267} height={534} />
          })
        }
      </div>
    </div>
