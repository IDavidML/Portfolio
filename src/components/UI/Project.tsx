      ...
      <div className="group relative grid  transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
        ...
        <div className="z-10 sm:col-span-6">
          <h3 className="font-medium flex flex-col gap-1 text-blue-300">
            <div>
              <a className="inline-flex items-baseline font-medium leading-tight dark:text-blue-200 text-blue-800 hover:dark:text-blue-100 hover:text-blue-800 focus-visible:text-blue-100  group/link text-lg" href="https://play.google.com/store/apps/details?id=com.github.davidml16.autobusesdelabahia" target="_blank" aria-label="Transporte del Sur">
